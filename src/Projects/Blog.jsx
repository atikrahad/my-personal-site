    ...
    <div className="flex md:flex-row flex-col-reverse relative md:justify-between">
      <div className="md:w-[70%]">
        ...
        <div className="flex flex-wrap pt-5 gap-5">
            <a href="https://blog-site-68835.web.app/" target="_blank"><button style={{ boxShadow: "2px 4px 16px #2e5354" }} className="btn bg-slate-600 rounded-md border-none text-cyan-400  hover:text-slate-800 "><AiOutlineEye ></AiOutlineEye> Live Preview</button></a>
            <a href="https://github.com/atikrahad/write-article-clientside" target="_blank"><button style={{ boxShadow: "2px 4px 16px #2e5354" }} className="btn bg-slate-600 rounded-md border-none text-cyan-400  hover:text-slate-800"><AiOutlineGithub></AiOutlineGithub> Front End</button></a>
            <a href="https://github.com/atikrahad/write-article-server" target="_blank"><button style={{ boxShadow: "2px 4px 16px #2e5354" }} className="btn bg-slate-600 rounded-md border-none text-cyan-400  hover:text-slate-800"><AiOutlineGithub></AiOutlineGithub> Back End</button></a>
        </div>
      </div>
